...
If ($Add_PS1 -eq $True) {
	...
	$Command_For_Basic_PS1 = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type PS1Basic -ScriptPath "%V"'
	$Command_For_Params_PS1 = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type PS1Params -ScriptPath "%V"'
	$Command_For_System_PS1 = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type PS1System -ScriptPath "%V"'
...
If ($Add_Intunewin -eq $True) {
	...
	$Command_for_Intunewin = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type Intunewin -ScriptPath "%V"'
...
If ($Add_Reg -eq $True) {
	...
	$Command_for_Reg = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type REG -ScriptPath "%V"'
...
If ($Add_ISO -eq $True) {
	...
	$Command_for_ISO = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type ISO -ScriptPath "%V"'
...
If ($Add_PPKG -eq $True) {
	...
	$Command_for_PPKG = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type PPKG -ScriptPath "%V"'
...
If ($Add_HTML -eq $True) {
	...
	If (Test-Path $HTML_Edge_Shell_Registry_Key) {
		...
		If (-not (Test-Path $HTML_Edge_Key_Label_Path) ) {
			...
			$Command_for_HTML = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type HTML -ScriptPath "%V"'
	...
	If (Test-Path $URL_Shell_Registry_Key) {
		...
		If (-not (Test-Path $URL_Key_Label_Path) ) {
			...
			$Command_for_URL = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type URL -ScriptPath "%V"'
...
If ($Add_MultipleApp -eq $True) {
	...
	$Command_for_MultipleApps = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type SDBApp -ScriptPath "%V"'
...
If ($Add_VBS -eq $True) {
	...
	$Command_For_Basic_VBS = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type VBSBasic -ScriptPath "%V"'
	$Command_For_Params_VBS = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type VBSParams -ScriptPath "%V"'
	# Set the command path
...
If ($Add_EXE -eq $True) {
	...
	$Command_For_EXE = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type EXE -ScriptPath "%V"'
	# Set the command path
...
If ($Add_MSI -eq $True) {
	...
	$Command_For_MSI = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type MSI -ScriptPath "%V"'
	# Set the command path
...
If ($Add_ZIP -eq $True) {
	...
	$Command_For_ZIP = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type ZIP -ScriptPath "%V"'
	# Set the command path
	...
	If (Test-Path $7z_Shell_Registry_Key) {
		...
		If (Test-Path $Default_ZIP_Shell_Registry_Key) {
			...
			$Command_for_Default_ZIP = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type 7Z -ScriptPath "%V"'
			If (Test-Path $Default_ZIP_Shell_Registry_Key) {
...
If ($Add_MSIX -eq $True) {
	...
	$Command_for_MSIX = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -WindowStyle Hidden -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type MSIX -ScriptPath "%V"'
...
If ($Add_Folder -eq $True) {
	...
	$Command_For_Folder_Inside = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type Folder_Inside -ScriptPath "%V"'
	# Set the command path
	...
	$Command_For_Folder_On = 'C:\\Windows\\system32\\WindowsPowerShell\\v1.0\\powershell.exe -NoProfile -ExecutionPolicy Unrestricted -sta -File C:\\ProgramData\\Run_in_Sandbox\\RunInSandbox.ps1 -Type Folder_On -ScriptPath "%V"'
	# Set the command path

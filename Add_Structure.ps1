				...
				If(test-path $Sources)
					{
						...
						If($Check_Sources_Files_Count -eq 16)	
							{	
														...
														If($HKCR_Mapped -eq $True)
															{
																...
																# reg export HKEY_CLASSES_ROOT\exefile "$Destination_folder\Backup_HKRoot_EXEFile.reg"
																# reg export "HKEY_CLASSES_ROOT\Microsoft.PowerShellScript.1" "$Destination_folder\Backup_HKRoot_PowerShellScript.reg"
																# reg export "HKEY_CLASSES_ROOT\VBSFile" "$Destination_folder\Backup_HKRoot_VBSFile.reg"
																# reg export "HKEY_CLASSES_ROOT\Msi.Package" "$Destination_folder\Backup_HKRoot_Msi.reg"				
																# reg export "HKEY_CLASSES_ROOT\CompressedFolder" "$Destination_folder\Backup_HKRoot_CompressedFolder.reg"
																# reg export "HKEY_CLASSES_ROOT\WinRAR.ZIP" "$Destination_folder\Backup_HKRoot_WinRAR.reg"
																# reg export "HKEY_CLASSES_ROOT\Directory" "$Destination_folder\Backup_HKRoot_Directory.reg"
